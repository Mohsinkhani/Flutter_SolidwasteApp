      ...
      body: HwIntroductionScreen(
        ...
        items: [
          ...
          HwIntroductionItem(
              ...
              caption:
                  'Every one Have Responsibility to Clean Environment ', // String
              image:
                  Lottie.asset('images/into3.json', fit: BoxFit.cover) // Widget
              ),
          HwIntroductionItem(
            title: 'Protect From Diseases', // String
            caption: 'Clean Environment Protect From Disease ', // String
            image: Lottie.asset('images/intro2.json',
                fit: BoxFit.cover, alignment: Alignment.center), // Widget
          ),
          HwIntroductionItem(
            title: 'Complaint away By One Click', // String
            caption: 'You can Complaint From Any Where', // String
            image: Lottie.asset('images/intro4.json',
                fit: BoxFit.cover, alignment: Alignment.center), // Widget
          ),
        ],
